...
public class HandleGlobalException {
	...
	ModelAndView InstantiationException(InstantiationException e){
		e.printStackTrace();
		ModelAndView mView = new ModelAndView();
		mView.addObject("实例化异常");
		mView.addObject(e.getStackTrace());
		mView.setViewName("/error/user_error");
		return mView;
	}
	...
	ModelAndView ClassNotFoundException(ClassNotFoundException e){
		e.printStackTrace();
		ModelAndView mView = new ModelAndView();
		mView.addObject("找不到类异常");
		mView.addObject(e.getStackTrace());
		mView.setViewName("/error/user_error");
		return mView;
	}
