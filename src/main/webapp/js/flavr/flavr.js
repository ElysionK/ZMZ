...
;(function() {
    ...
    $.flavr = function(){
        ...
        */  if( isempty( arguments )) {
        ...
        {
            /* DOM components */
            var container   = $('<div class="flavr-container flavrmodal"></div>');
            ...
            */  if( 'confirm' == me.settings.dialog ) {
                    me.defaults.buttons = {
                        confirm : { text: '确认', style: 'error', addClass: null,
                            action : function()
                            {
                        ...
                        cancel : { text: '取消', style: 'info', addClass: null,
                            action : function()
                            {
            ...
            */  if( 'form' == me.settings.dialog ) {
                    ...
                    message.append( form );
                    if( notnull( me.settings.formId )) message.attr("id", me.settings.formId);
